...
echo "Command: DeterminateManual: 18" >> /var/tmp/depnotify.log
...
echo "Command: DeterminateManualStep:" >> /var/tmp/depnotify.log
echo "Status: Securty Scripts finished"
...
#
####################################
echo "Status: Installing Administrator Tools" >> /var/tmp/depnotify.log
...
echo "Command: DeterminateManualStep:" >> /var/tmp/depnotify.log
echo "Status: Finished Installing Administrator Tools" >> /var/tmp/depnotify.log
#############################
#
#
# INSTALL SOFTWARE
...
#install Browsers #
echo "Status: Installing FireFox 50" >> /var/tmp/depnotify.log
...
#
################################
echo "Status: Software Installed" >> /var/tmp/depnotify.log
echo "Status: Please check self-service for additional software" >> /var/tmp/depnotify.log
echo "Status: Installing Browser Plugins" >> /var/tmp/depnotify.log
...
echo "Command: Restart: All Done! Your computer will now restart." >> /var/tmp/depnotify.log
