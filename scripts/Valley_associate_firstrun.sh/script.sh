...
# Install Lanschool FIX THIS FOR VALLEY
...
# Install Type to learn
sudo jamf policy -event typetolean

# Istall google earth
sudo jamf policy -event googleearth

# install Printer drivers
sudo jamf policy -event hpprintdrivers
